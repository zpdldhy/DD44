...
public:
	...
	void SetObjectEditorCallback(std::function<void(const char*, const char*, const char*, Vec3, Vec3, Vec3, Vec3, float, Vec3, float, const ShapeComponentData&)> callback)
	{
